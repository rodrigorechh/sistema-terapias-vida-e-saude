...
$query_event = "UPDATE events SET title=:title, color=:color, start=:start, end=:end, id_cpf=:id_cpf, valor=:valor WHERE id=:id";
...
$update_event->bindParam(':id_cpf', $dados['id_cpf']);
$update_event->bindParam(':valor', $dados['valor']);

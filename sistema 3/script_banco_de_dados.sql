...
VALUES ('Maria da Silva', '23', 'mariadasilva@gmail.com', '1991-10-10','1111111111', '11111111111', 'Sem débito', "06122019_padrao.jpg", '11111111111', 'F');

INSERT INTO `tab_clientes` (`nome`, `idade`, `email`, `data_nascimento`,`telefone`, `celular`, `status`, `foto`, `cpf`, `genero`) 
VALUES ('joão da Silva', '25', 'joaodasilva@gmail.com', '1980-10-10','2222222222', '22222222222', 'Sem débito', "06122019_padrao.jpg", '22222222222', 'M');

INSERT INTO `tab_clientes` (`nome`, `idade`, `email`, `data_nascimento`,`telefone`, `celular`, `status`, `foto`, `cpf`, `genero`) 
VALUES ('Paulo Darf', '23', 'paulodarfa@gmail.com', '1990-10-10','3333333333', '33333333333', 'Sem débito', "06122019_padrao.jpg", '33333333333', 'M');

INSERT INTO `tab_clientes` (`nome`, `idade`, `email`, `data_nascimento`,`telefone`, `celular`, `status`, `foto`, `cpf`, `genero`) 
VALUES ('Maico Ramos', '322', 'maicoramos@gmail.com', '1988-10-10','4444444444', '44444444444', 'Sem débito', "06122019_padrao.jpg", '44444444444', 'M');

INSERT INTO `tab_clientes` (`nome`, `idade`, `email`, `data_nascimento`,`telefone`, `celular`, `status`, `foto`, `cpf`, `genero`) 
VALUES ('Judas', '23', 'judas@gmail.com',  '1989-10-10','5555555555','55555555555', 'Sem débito', "06122019_padrao.jpg", '55555555555', 'M');

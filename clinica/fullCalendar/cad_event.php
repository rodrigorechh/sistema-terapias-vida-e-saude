...
$query_event = "INSERT INTO events (title, color, start, end, id_cpf, valor) VALUES (:title, :color, :start, :end, :id_cpf, :valor)";
...
$insert_event->bindParam(':id_cpf', $dados['id_cpf']);
$insert_event->bindParam(':valor', $dados['valor']);
